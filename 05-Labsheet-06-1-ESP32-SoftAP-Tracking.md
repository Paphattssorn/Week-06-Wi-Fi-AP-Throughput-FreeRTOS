...
2. สมาชิกตัวแปร `mac` ในโครงสร้าง `wifi_event_ap_staconnected_t` สามารถนำไปประยุกต์ใช้ทำระบบความปลอดภัยขั้นสูง (เช่น MAC Filtering) ได้อย่างไร?
    เมื่อมีอุปกรณ์เชื่อมต่อเข้ามา Event WIFI_EVENT_AP_STACONNECTED จะถูกเรียกทำงานทันที ทำให้เราได้ค่า MAC Address ของเครื่องนั้นมาผ่านตัวแปร mac เราสามารถเขียนโค้ดเพิ่มเพื่อนำค่านี้ไปตรวจสอบกับบัญชีขาว (Whitelist) (รายชื่อ MAC ที่อนุญาตให้ใช้งาน) หรือ บัญชีดำ (Blacklist)
