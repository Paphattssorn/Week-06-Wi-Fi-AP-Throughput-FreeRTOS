...
| :---: | :--- | :---: | :---: | :---: |
| **1** |42:77:3E:7B:A7 | -45 dBm|NEAR |valid |
| **2** | 5E:28:92:BC:24:01| -45 dBm|- | -|
...
1. การใช้ **RF Signal Proximity (RSSI)** ร่วมกับ **HTTP Web Server** บน ESP32 แก้ปัญหาการฝากเช็กชื่อแทนกันในห้องเรียนได้อย่างไร?
    ใช้ RSSI เป็นตัวยืนยัน ระยะทางกายภาพ Web Server จะยอมรับคำสั่งเช็กชื่อก็ต่อเมื่ออุปกรณ์ของนักเรียนมีสัญญาณแรงพอ (อยู่ใกล้ ESP32 ในห้อง) ทำให้เพื่อนที่อยู่นอกห้องหรืออยู่ไกล ไม่สามารถกดลิงก์เช็กชื่อแทนกันได้
2. เหตุใดระดับเกณฑ์ RSSI ที่ `-55 dBm` จึงเหมาะสมสำหรับการระบุตำแหน่งอุปกรณ์ให้อยู่ภายในรัศมีโต๊ะปฏิบัติการ?
    ค่า -55 dBm เป็นระดับสัญญาณที่เทียบเท่ากับระยะห่างประมาณ 1-2 เมตร ซึ่งครอบคลุมพื้นที่รอบโต๊ะปฏิบัติการพอดี หากตั้งค่าน้อยกว่านี้ (เช่น -70 dBm) รัศมีจะกว้างเกินไปจนอาจรับเช็กชื่อคนอยู่นอกห้องได้
3. หากต้องการต่อยอดมินิโปรเจกต์นี้ในอนาคต ให้สามารถบันทึกข้อมูลการเข้าเรียนลงระบบ Cloud (เช่น Google Sheets หรือ Firebase) จะต้องเพิ่มส่วนเชื่อมต่อใดบ้าง?
    ต้องตั้งค่า ESP32 เป็นโหมด Station (STA) เพื่อเชื่อมต่อกับ Wi-Fi เร้าเตอร์ให้ออกอินเทอร์เน็ตได้ ต้องเพิ่มไลบรารี HTTP/HTTPS Client (สำหรับยิง Webhook ไปยัง Google Apps Script/Google Sheets) หรือใช้ไลบรารี Firebase ESP32 Client เพื่อบันทึกข้อมูลลง Database โดยตรง
